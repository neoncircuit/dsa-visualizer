...
echo ""
echo "=== Optional: Feedback Backend ==="
echo ""
echo "To enable the feedback feature, configure environment variables:"
echo ""
echo "1. Copy .env.example to .env.local:"
echo "   cp .env.example .env.local"
echo ""
echo "2. For Supabase (default):"
echo "   - Create a project at https://supabase.com"
echo "   - Copy values from Settings > API"
echo "   - Uncomment and fill in VITE_SUPABASE_* variables"
echo ""
echo "3. For Firebase (alternative):"
echo "   - Create a project at https://console.firebase.google.com"
echo "   - Enable Firestore database"
echo "   - Uncomment and fill in VITE_FIREBASE_* variables"
echo ""
echo "4. Restart the dev server to apply changes"
echo ""
